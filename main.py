...
def get_friendly_locale(locale: str) -> str:
    lang_map = {
        ...
        "gl": "🇪🇸 Tiếng Galicia", "eu": "🇪🇸 Tiếng Basque", "mk": "🇲🇰 Tiếng Macedonia",
        "sq": "🇦🇱 Tiếng Albania", "am": "🇪🇹 Tiếng Amharic", "uz": "🇺🇿 Tiếng Uzbekistan",
        "kk": "🇰🇿 Tiếng Kazakhstan", "mn": "🇲🇳 Tiếng Mông Cổ", "mr": "🇮🇳 Tiếng Marathi",
        "ne": "🇳🇵 Tiếng Nepal", "si": "🇱🇰 Tiếng Sinhala", "ml": "🇮🇳 Tiếng Malayalam",
        "kn": "🇮🇳 Tiếng Kannada", "gu": "🇮🇳 Tiếng Gujarati", "pa": "🇮🇳 Tiếng Punjab",
        "so": "🇸🇴 Tiếng Somali", "sl": "🇸🇮 Tiếng Slovenia", "et": "🇪🇪 Tiếng Estonia",
        "lv": "🇱🇻 Tiếng Latvia", "lt": "🇱🇹 Tiếng Litva"
    }
...
async def get_voices():
    ...
    for v in voices:
        ...
        market = get_friendly_locale(v.get("Làocale", "Unknown"))
